...
export const ChatImpl = memo(
  ({ description, initialMessages, storeMessageHistory, importChat, exportChat }: ChatProps) => {
    ...
    const [nexusLastTarget, setNexusLastTarget] = useState<string | null>(null);
    ...
    const sendMessage = async (_event: React.UIEvent, messageInput?: string) => {
      ...
      if (!chatStarted) {
        ...
        // Skip starter template selection when Nexus/BMAD handled the request
        if (nexusLastTarget === 'bmad') {
          setNexusLastTarget(null); // Reset for next request
          setFakeLoading(false);
          setChatStarted(true);
          return;
        }
      ...
      <BaseChat
        ...
        messages={(() => {
          ...
          return allMessages.map((message, i) => {
            ...
            // For BMAD/Nexus messages (id starts with 'bmad-', 'archon-', 'nexus-'), keep original content
            const isBmadMessage = message.id?.startsWith('bmad-') || message.id?.startsWith('archon-') || message.id?.startsWith('nexus-');
