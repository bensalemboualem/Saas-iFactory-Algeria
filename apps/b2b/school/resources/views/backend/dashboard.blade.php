...
<div class="page-content">
    <div class="row ">
        ...
        {{-- Counter --}}
        {{-- FIX: Affichage forcé avec styles inline pour BBC School Algeria --}}
        <div class="col-xl-3 col-lg-3 col-md-6">
           <a href="{{ route('student.index') }}" style="text-decoration: none;">
                <div style="background: white; border-radius: 10px; padding: 20px; display: flex; align-items: center; margin-bottom: 24px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                    <div style="width: 60px; height: 60px; background: #4CAF50; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                        <span style="color: white; font-size: 24px;">🎓</span>
                    </div>
                    <div>
                        <h4 style="font-size: 36px; margin: 0; color: #333; font-weight: bold;">{{ $data['student'] ?? 0 }}</h4>
                        <h1 style="font-size: 16px; margin: 5px 0 0 0; color: #666;">{{ ___('dashboard.Student') }}</h1>
                    </div>
                </div>
           </a>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-6">
           <a href="{{ route('parent.index') }}" style="text-decoration: none;">
             <div style="background: white; border-radius: 10px; padding: 20px; display: flex; align-items: center; margin-bottom: 24px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <div style="width: 60px; height: 60px; background: #FF9800; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                    <span style="color: white; font-size: 20px;">👨‍👩‍👧‍👦</span>
                </div>
                <div>
                    <h4 style="font-size: 36px; margin: 0; color: #333; font-weight: bold;">{{ $data['parent'] ?? 0 }}</h4>
                    <h1 style="font-size: 16px; margin: 5px 0 0 0; color: #666;">{{ ___('dashboard.Parent') }}</h1>
                </div>
            </div>
           </a>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-6">
            <a href="{{ route('users.index') }}" style="text-decoration: none;">
                <div style="background: white; border-radius: 10px; padding: 20px; display: flex; align-items: center; margin-bottom: 24px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                    <div style="width: 60px; height: 60px; background: #2196F3; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                        <span style="color: white; font-size: 24px;">👨‍🏫</span>
                    </div>
                    <div>
                        <h4 style="font-size: 36px; margin: 0; color: #333; font-weight: bold;">{{ $data['teacher'] ?? 0 }}</h4>
                        <h1 style="font-size: 16px; margin: 5px 0 0 0; color: #666;">{{ ___('academic.teacher') }}</h1>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-xl-3 col-lg-3 col-md-6">
            <a href="{{ route('sessions.index') }}" style="text-decoration: none;">
                <div style="background: white; border-radius: 10px; padding: 20px; display: flex; align-items: center; margin-bottom: 24px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                    <div style="width: 60px; height: 60px; background: #9C27B0; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 15px;">
                        <span style="color: white; font-size: 24px;">📅</span>
                    </div>
                    <div>
                        <h4 style="font-size: 36px; margin: 0; color: #333; font-weight: bold;">{{ $data['session'] ?? 0 }}</h4>
                        <h1 style="font-size: 16px; margin: 5px 0 0 0; color: #666;">{{ ___('settings.Session') }}</h1>
                    </div>
                </div>
            </a>
        </div>
