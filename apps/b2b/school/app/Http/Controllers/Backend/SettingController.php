...
class SettingController extends Controller
{
    ...
    {
        // SECURITY: Migrations should not be triggered from HTTP requests.
        // Run migrations via CLI during deployment:
        //   php artisan migrate --force
        //
        // This endpoint now returns an informational message instead.
        return redirect()->back()->with('info', ___('alert.please_run_migrations_via_cli'));
    }
