...
class AuthenticationController extends Controller
{
    ...
    {
        // SECURITY: REMOVED - Artisan migrate/seed must NEVER run from HTTP context
        // Database migrations should be handled via deployment scripts or CI/CD:
        //   php artisan migrate --force
        //   php artisan db:seed --force
        //
        // If tables are missing, the application should fail gracefully, not auto-migrate.
