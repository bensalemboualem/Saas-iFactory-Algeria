...
Route::middleware(saasMiddleware())->group(function () {
    ...
    Route::prefix('admin')->middleware(['admin', 'auth', 'verified'])->group(function () {
        ...
        Route::controller(ConversationController::class)->group(function () {
            Route::get('/conversation-list', 'conversationList')->name('admin.livechat.conversations');
            Route::get('/conversation', 'conversation')->name('admin.livechat.conversation.show');
        });
    });
