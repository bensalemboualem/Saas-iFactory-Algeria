...
const configSchema = z.object({
  ...
  // Redis (optional - uses in-memory store if not provided)
  ...
  // Billing Mode
  BILLING_MODE: z.enum(['beta', 'chargily', 'stripe']).default('beta'),

  // Beta Settings
  BETA_SIGNUP_CREDITS: z.coerce.number().default(5.0),
  BETA_DAILY_LIMIT: z.coerce.number().default(2.0),
