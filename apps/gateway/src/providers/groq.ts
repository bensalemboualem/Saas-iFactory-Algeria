...
export class GroqProvider implements BaseProvider {
  ...
  constructor() {
    ...
    // The Groq SDK automatically appends /openai/v1 to the base URL
    // So we only pass the base domain (https://api.groq.com)
    // DO NOT append /openai/v1 manually - the SDK does it
