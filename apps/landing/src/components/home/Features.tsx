...
const FEATURES = [
  {
    ...
    desc: "Envoyez rapidement votre prompt a un autre modele et exploitez la diversite des IA. L'avenir est multi-modele.",
  },
  {
    id: 'projects',
    icon: (
    ...
    desc: 'Configurez votre IA Factory personnalise avec un contexte adapte pour soutenir vos projets plus efficacement.',
  },
  {
    id: 'uploads',
    icon: (
    ...
    title: "TELECHARGEMENTS D'IMAGES ET DE FICHIERS",
    descKey: 'features.f3.desc',
    desc: "Telechargez facilement des images et des documents pour extraire des informations grace a l'analyse IA.",
  },
  {
    id: 'multidevice',
    icon: (
  ...
  },
  {
    ...
    desc: 'Trouvez des reponses bien sourcees a partir de contenus web recents.',
  },
  {
    id: 'voice',
    icon: (
    ...
    desc: "Ayez des conversations vocales en temps reel avec l'IA.",
  },
];
    ...
    <section className="features-section" id="features">
      <div className="container">
        <div className="section-title">
          <h2 data-i18n="features.title">Fonctionnalites de IA Factory</h2>
          <p data-i18n="features.subtitle">Boostez votre productivite avec l'IA</p>
        </div>
