...
const PRIVACY_FEATURES = [
  {
    ...
    title: 'CONFORMITE LOCALE',
    descKey: 'privacy.p1.desc',
    desc: 'Nous traitons les donnees conformement aux lois algeriennes.',
  },
  {
    id: 'notraining',
    icon: (
    ...
    title: "AUCUN ENTRAINEMENT DE MODELE",
    descKey: 'privacy.p2.desc',
    desc: "Votre contenu n'est jamais utilise pour entrainer des modeles.",
  },
  {
    id: 'datasecurity',
    icon: (
    ...
    desc: 'Vos donnees sont chiffrees et stockees en toute securite.',
  },
];
    ...
    <section className="privacy-section">
      <div className="container">
        <div className="section-title">
          <h2 data-i18n="privacy.title">Confidentialite des donnees</h2>
          <p data-i18n="privacy.subtitle">Restez maitre de vos donnees</p>
        </div>
