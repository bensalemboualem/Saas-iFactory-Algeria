...
// TypeScript strict rules - avertir sur `any` explicite pour empêcher de nouveaux usages
// Les 426 existants sont tolérés mais les nouveaux seront signalés
config.rules['@typescript-eslint/no-explicit-any'] = 'warn';

// Empêcher console.log en production (préférer logger structuré)
config.rules['no-console'] = ['warn', { allow: ['warn', 'error'] }];
