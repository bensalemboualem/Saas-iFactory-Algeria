...
class DashboardController extends Controller
{
    ...
    {
        // Récupérer les statistiques réelles depuis le repository
        $data = $this->repo->index();

        // Les vraies données proviennent de:
        // - SessionClassStudent pour les étudiants actifs
        // - ParentGuardian pour les parents
        // - Staff (role_id=5) pour les enseignants
        // - Session pour les sessions/années
