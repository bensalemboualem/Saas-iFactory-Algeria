                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('admission_no') is-invalid @enderror"
                                        type="number" name="admission_no" list="datalistOptions" id="admissionNoField"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('roll_no') is-invalid @enderror"
                                        name="roll_no" list="datalistOptions" id="rollNoField" type="number"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('first_name') is-invalid @enderror"
                                        name="first_name" list="datalistOptions" id="firstNameField"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('last_name') is-invalid @enderror"
                                        name="last_name" list="datalistOptions" id="lastNameField"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select
                                        ...
                                        name="department_id" id="departmentId" required>
