            ...
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('parent.leave.store') }}" enctype="multipart/form-data" method="post" id="marksheet">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <select
                                                    ...
                                                    name="student">
                                                    <option value="">{{ ___('student_info.select child') }}</option>
                                                    @foreach($data['students'] as $student)
                                                        <option value="{{ $student->user_id }}"
                                                            {{ isset($data['editLeave']) && $data['editLeave']->user_id == $student->user_id ? 'selected' : '' }}>
                                            ...
                                            <input type="hidden" name="editLeaveId" value="{{ $data['editLeave']->id ?? null }}">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea class="form-control ot-textarea mt-0 @error('description') is-invalid @enderror"
                                                          name="description">{{ old('description', $data['editLeave']->description ?? '') }}</textarea>
                                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered role-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="purchase">{{ ___('common.Start Date') }}</th>
                                        <th class="purchase">{{ ___('common.End Date') }}</th>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end ">
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                       href="{{ route('parent.leave.edit', $row->id) }}"><span
                                                                            class="icon mr-8"><i
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                                       onclick="delete_row('parent/leave/delete', {{ $row->id }})">
