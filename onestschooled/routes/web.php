...
use App\Http\Controllers\BBCSchoolChatbotController;
...
Route::middleware(saasMiddleware())->group(function () {
    ...
    Route::get('/test-emails', function () {
        try {
            ...
            //     'port' => 587,
            //     'encryption' => 'tls',
            //     'username' => 'alofuqprivateschool@gmail.com',
            //     'password' => 'l y x x p i o f w a s p x o b v', // ❗ Use a Gmail App Password
            //     'timeout' => null,
            //     'auth_mode' => null,
            // ];
            ...
            //     'port' => 2525,
            //     'encryption' => 'tls',
            //     'username' => '5e82a8475c24c2',
            //     'password' => '8f16e22a8f81f1', // ❗ Use a Gmail App Password
            //     'timeout' => null,
            //     'auth_mode' => null,
            // ];
            ...
            Mail::to('onestdev125@gmail.com')->send(new TestMail());
    ...
    Route::group(['middleware' => ['XssSanitizer', 'lang']], function () {
        ...
        Route::group(['middleware' => ['CheckSubscription']], function () {
            ...
            // SECURITY: REMOVED - These dangerous routes allowed DB reset via HTTP
            // Run via CLI instead:
...
// LiveChat Fallback Routes - BBC School Algeria
require_once __DIR__ . '/livechat-fallback.php';

// BBC School Chatbot Routes - Intégré OnestSchool
Route::prefix('chatbot')->name('chatbot.')->group(function () {
    Route::get('/', [ChatbotController::class, 'index'])->name('index');
    Route::post('/api', [ChatbotController::class, 'api'])->name('api');
    Route::post('/message', [ChatbotController::class, 'handleMessage'])->name('message');
    Route::post('/analytics', [ChatbotController::class, 'analytics'])->name('analytics');
    Route::get('/stats', [ChatbotController::class, 'getStats'])->name('stats');
    Route::get('/vitrine', function () {
        return redirect('/bbc-ia-vitrine.html');
    })->name('vitrine');
    Route::get('/dashboard', function () {
        return redirect('/bbc-chatbot-pro.html');
    })->name('dashboard');
    
    // BBC School Algeria Chatbot Routes
    Route::post('/chatbot/chat', [BBCSchoolChatbotController::class, 'chat'])->name('bbc.chatbot.chat');
    Route::post('/chatbot/action', [BBCSchoolChatbotController::class, 'quickAction'])->name('bbc.chatbot.action');
    Route::get('/chatbot/context', [BBCSchoolChatbotController::class, 'getContextData'])->name('bbc.chatbot.context');
    
    // Knowledge Base Seeder (temporaire)
    Route::get('/seed-knowledge', [App\Http\Controllers\KnowledgeBaseSeeder::class, 'seedOnestSchoolGuide']);
    
    // BBC School Algeria Instagram Integration
    Route::get('/instagram', function() {
        return view('frontend.instagram');
    })->name('frontend.instagram');
    Route::get('/instagram/gallery', [App\Http\Controllers\InstagramController::class, 'gallery'])->name('instagram.gallery');
    Route::get('/api/instagram', [App\Http\Controllers\InstagramController::class, 'api'])->name('instagram.api');
    Route::get('/api/instagram/category/{category}', [App\Http\Controllers\InstagramController::class, 'byCategory'])->name('instagram.category');
});
